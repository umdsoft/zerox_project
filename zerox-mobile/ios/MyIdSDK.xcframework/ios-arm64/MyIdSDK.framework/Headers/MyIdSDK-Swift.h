...
enum MyIdViewState : NSInteger;
enum MyIdShapeMode : NSInteger;
enum MyIdResidency : NSInteger;

SWIFT_CLASS("_TtC7MyIdSDK11MyIdOptions")
@interface MyIdOptions : NSObject
...
@property (nonatomic) enum MyIdViewState viewState;
@property (nonatomic) enum MyIdShapeMode shapeMode;
...
- (nonnull instancetype)initWithPhone:(NSString * _Nullable)phone logo:(UIImage * _Nullable)logo OBJC_DESIGNATED_INITIALIZER;
...
@protocol MyIdSdkDelegate;

SWIFT_CLASS("_TtC7MyIdSDK7MyIdSdk")
@interface MyIdSdk : NSObject
+ (void)startWithConfigureOptions:(void (^ _Nonnull)(MyIdOptions * _Nullable))configureOptions withDelegate:(id <MyIdSdkDelegate> _Nonnull)delegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL("_TtP7MyIdSDK15MyIdSdkDelegate_")
@protocol MyIdSdkDelegate
- (void)myidOnSuccessWithResult:(MyIdResult * _Nonnull)result;
- (void)myidOnErrorWithException:(MyIdException * _Nonnull)exception;
- (void)myidOnUserExited;
@end

typedef SWIFT_ENUM(NSInteger, MyIdShapeMode, open) {
  MyIdShapeModeOVAL = 0,
  MyIdShapeModeCIRCLE = 1,
};

typedef SWIFT_ENUM(NSInteger, MyIdViewState, open) {
  MyIdViewStateHALF = 0,
  MyIdViewStateFULL = 1,
};
