    ...
    <div class="pagebreak">
      <div class="box qarz">
        <div class="content-title">
          ...
          <p>
            ( <span>{{ contract.number }}</span> - сонли қарз шартномаси бўйича
            муддатни узайтириш буйича тўғрисида )
          </p>
        </div>
        <div class="content-body">
          ...
          <p>
            ...
            <b>{{ dateFormat(act.end_date) }}</b> йилгача узайтирилди.
          </p>
          <p>
            <b>{{ contract.number }}</b
            >-сонли қарз шартномасининг янги муддати сифатида
            <b>{{ dateFormat(act.end_date) }}</b> йил белгиланди.
          </p>
          <p>
