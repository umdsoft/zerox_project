      ...
      <div class="box qarz">
        <div class="content-title">
          ...
          <p>
            ...
            қарз маблағи олинганлиги тўғрисида )
          </p>
        </div>
        <div class="content-body">
          ...
          <p>
            ...
            >га <b>{{ dateFormat(contract.createdAt) }} </b> йилдаги
            <span>{{ contract.number }}</span> -сонли қарз шартномасига асосан
            <span>{{
              contract.amount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ")
            }}</span>
            {{ contract.currency }} миқдордаги пул маблағини
            <span> {{ dateFormat(act.end_date) }}</span> йилгача фоизсиз қарз
            сифатида топширилди.
          </p>
          <p>
