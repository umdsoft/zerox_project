      ...
      <div class="box qarz">
        <div class="content-title">
          ...
          <p>
            ...
            қарз маблағи қисман қайтарилганлиги тўғрисида )
          </p>
        </div>
        <div class="content-body">
          ...
          <p>
            ...
            >га {{ dateFormat(contract.createdAt) }} йилдаги
            <span>{{ contract.number }}</span> - сонли қарз шартномасига асосан
            <span> {{ contract.amount.toString()
                      .replace(/\B(?=(\d{3})+(?!\d))/g, " ") }} {{ contract.currency }}</span>
            ймиқдорида олинган қарз маблағининг
            <span>{{ act.refundable_amount.toString()
                      .replace(/\B(?=(\d{3})+(?!\d))/g, " ") }} {{ contract.currency }}</span>
            миқдоридаги қисми {{ dateFormat(act.createdAt) }} йилда қайтарилди.
          </p>
          <p>
          ...
          <p>
            ...
            <span>{{ act.residual_amount.toString()
                      .replace(/\B(?=(\d{3})+(?!\d))/g, " ") }} {{ contract.currency }}</span>
            қайтариш муддати {{ dateFormat(act.createdAt) }} йил қилиб
            белгиланди.
          </p>
          <p>
