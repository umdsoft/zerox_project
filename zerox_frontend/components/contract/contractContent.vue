<template>
  <div>
    ...
    <div class="box qarz">
      ...
      <div class="content-body">
        <p>
          ...
          >
          йилда <span>{{ contract.debitor.issued_by }}</span> томонидан
          берилган) (кейинги ўринларда “Қарз берувчи”) биринчи томондан,
          <span>
          ...
          томонидан берилган) (кейинги ўринларда “Қарз олувчи”) иккинчи томондан
          ҳамда “Infinity payment system” МЧЖ (СТИР: 309053853) (кейинги
          ўринларда “Жамият”) учинчи томондан ушбу шартномани қуйидагилар ҳақида
          туздилар
        </p>
      </div>
    </div>
        ...
        <ul>
          <li>
            <p>
              ...
              {{ contract.currency }} миқдорида пул маблағини фоизсиз қарзга
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              имзо билан имзоланишига розилигини билдиради ҳамда махсус электрон
              имзо қўлда қўйилган имзо билан бир ҳил аҳамиятга эга эканлигини
              зиммасига олади.
            </p>
          </li>
          <li>
            <p>
              ...
              <span>{{ dateFormat(contract.end_date) }}</span> йилга қадар амал
              қилади.
            </p>
          </li>
          <li>
    ...
    <div class="box qarz pagebreak">
      <div class="content-title">
        <h2 class="">5.Томонларнинг реквизитлари</h2>
      </div>
      <div class="content-body">
        <div class="flex">
          <div class="rekvizit">
            ...
            <div class="rek-body">
              <h2>
                Сана: <span>{{ dateFormat(contract.createdAt) }}</span> йил
              </h2>
            </div>
          </div>
          <div class="rekvizit">
            ...
            <div class="rek-body">
              <h2>Махсус электрон имзо:</h2>
              <h2 class="mt-4" v-if="contract.status == 1">
                <Vqr
